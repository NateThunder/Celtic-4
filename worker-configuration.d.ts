/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars --strict-vars=false` (hash: 4108e5cdfa0ccdb8bb79cb14cd5084c6)
...
interface __BaseEnv_Env {
	...
	COMMERCE_BACKUPS: R2Bucket;
	STEMS_DB: D1Database;
	COMMERCE_DB: D1Database;
	ASSETS: Fetcher;
	CHECKOUT_DISABLED: string;
	NEXT_PUBLIC_COMMERCE_DISABLED: string;
	NEXT_PUBLIC_WOO_URL: string;
	ADMIN_AUTH_REQUIRED: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHECKOUT_DISABLED" | "NEXT_PUBLIC_COMMERCE_DISABLED" | "NEXT_PUBLIC_WOO_URL" | "ADMIN_AUTH_REQUIRED" | "ADMIN_PASSWORD">> {}
}
